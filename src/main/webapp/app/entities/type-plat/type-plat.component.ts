...
export class TypePlatComponent implements OnInit, OnDestroy {
  ...
  trackId(index: number, item: ITypePlat) {
    return item.id;
  }

  registerChangeInTypePlats() {
    this.eventSubscriber = this.eventManager.subscribe('typePlatListModification', response => this.loadAll());
  }
  ...
  protected paginateTypePlats(data: ITypePlat[], headers: HttpHeaders) {
